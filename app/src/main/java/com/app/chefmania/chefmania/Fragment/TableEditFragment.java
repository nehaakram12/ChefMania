...
public class TableEditFragment extends android.support.v4.app.Fragment {
    ...
    public static TableEditFragment newInstance(String param1, String param2) {
        TableEditFragment fragment = new TableEditFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        TableActivity ia= ((TableActivity) getActivity());
        item_id=ia.table_item_id;
        ...
        ChildEventListener childListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if(dataSnapshot.getKey().equals(item_id)) {
                    ...
                    scapacity = dataSnapshot.child("capacity").getValue(Integer.class);
