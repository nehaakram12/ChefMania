...
public class EmployeeAddNewFragment extends android.support.v4.app.Fragment {
    ...
    public static EmployeeAddNewFragment newInstance(String param1, String param2) {
        EmployeeAddNewFragment fragment = new EmployeeAddNewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_employee_add_new, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        addbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference newRef = db.child("Employee").push();
