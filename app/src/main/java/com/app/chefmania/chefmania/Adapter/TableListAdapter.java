...
//        listArray.add(new DataModel("name5",  "Maven"));
    ...
    public TableListAdapter(Context context, ArrayList<DataModel> listArray) {
    ...
    public View getView(int index, View view, final ViewGroup parent) {
        ...
        viewpager = ((TableActivity) mcontext).findViewById(R.id.viewPager);

        editbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TableActivity ia= ((TableActivity) mcontext);
                ia.table_item_id=dataModel.getId().toString();
        ...
        deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent refresh = new Intent(mcontext, TableActivity.class);
                (mcontext).startActivity(refresh);
                ((TableActivity) mcontext).finish();
            }
        });
