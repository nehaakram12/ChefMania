...
import com.app.chefmania.chefmania.Adapter.EmployeeActivityPagerAdapter;
...
public class EmployeeActivity extends AppCompatActivity implements EmployeeViewAllFragment.OnFragmentInteractionListener,EmployeeAddNewFragment.OnFragmentInteractionListener,EmployeeEditFragment.OnFragmentInteractionListener{
    ...
    public String employee_item_id=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmployeeActivityPagerAdapter mainActivityPagerAdapter = new EmployeeActivityPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
