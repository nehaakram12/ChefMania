...
import com.app.chefmania.chefmania.Adapter.TabletActivityPagerAdapter;
...
public class TabletActivity extends AppCompatActivity implements TabletViewAllFragment.OnFragmentInteractionListener,TabletAddNewFragment.OnFragmentInteractionListener,TabletEditFragment.OnFragmentInteractionListener{
    ...
    public String tablet_item_id=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabletActivityPagerAdapter mainActivityPagerAdapter = new TabletActivityPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
