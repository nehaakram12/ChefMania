...
import com.app.chefmania.chefmania.Adapter.FoodMenuActivityPagerAdapter;
...
public class FoodMenuActivity extends AppCompatActivity implements FoodMenuViewAllFragment.OnFragmentInteractionListener,FoodMenuAddNewFragment.OnFragmentInteractionListener,FoodMenuEditFragment.OnFragmentInteractionListener{
    ...
    public String food_menu_item_id=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FoodMenuActivityPagerAdapter mainActivityPagerAdapter = new FoodMenuActivityPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
...
//        });
    ...
    public String getFood_menu_item_id() {
        return food_menu_item_id;
    }

    public void setFood_menu_item_id(String food_menu_item_id) {
