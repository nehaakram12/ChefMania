...
//        listArray.add(new DataModel("name5",  "Maven"));
    ...
    public EmployeeListAdapter(Context context, ArrayList<DataModel> listArray) {
    ...
    public View getView(int index, View view, final ViewGroup parent) {
        ...
        viewpager = ((EmployeeActivity) mcontext).findViewById(R.id.viewPager);

        editbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EmployeeActivity ia= ((EmployeeActivity) mcontext);
                ia.employee_item_id=dataModel.getId().toString();
        ...
        deletebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference db= FirebaseDatabase.getInstance().getReference("Employee");
                ...
                Intent refresh = new Intent(mcontext, EmployeeActivity.class);
                (mcontext).startActivity(refresh);
                ((EmployeeActivity) mcontext).finish();
            }
        });
