...
import com.app.chefmania.chefmania.Adapter.TableActivityPagerAdapter;
...
public class TableActivity extends AppCompatActivity implements TableViewAllFragment.OnFragmentInteractionListener,TableAddNewFragment.OnFragmentInteractionListener,TableEditFragment.OnFragmentInteractionListener{
    ...
    public String table_item_id=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TableActivityPagerAdapter mainActivityPagerAdapter = new TableActivityPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
