...
public class FoodMenuListAdapter extends BaseAdapter {
    private static final String TAG = FoodMenuListAdapter.class.getSimpleName();
    Context mcontext;
    ArrayList<DataModel> listArray;
    ViewPager viewpager;

    public FoodMenuListAdapter() {
...
//        listArray.add(new DataModel("name5",  "Maven"));
    ...
    public FoodMenuListAdapter(Context context, ArrayList<DataModel> listArray) {
    ...
    public View getView(int index, View view, final ViewGroup parent) {
        ...
        viewpager = ((FoodMenuActivity) mcontext).findViewById(R.id.viewPager);

        editbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FoodMenuActivity ia= ((FoodMenuActivity) mcontext);
                ia.food_menu_item_id=dataModel.getId().toString();
        ...
        deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent refresh = new Intent(mcontext, FoodMenuActivity.class);
                (mcontext).startActivity(refresh);
                ((FoodMenuActivity) mcontext).finish();
            }
        });
