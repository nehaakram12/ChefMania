...
import com.app.chefmania.chefmania.Adapter.AssignmentActivityPagerAdapter;
...
public class AssignmentActivity extends AppCompatActivity implements AssignmentViewAllFragment.OnFragmentInteractionListener,AssignmentAddNewFragment.OnFragmentInteractionListener,AssignmentEditFragment.OnFragmentInteractionListener{
    ...
    public String assignment_item_id=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AssignmentActivityPagerAdapter mainActivityPagerAdapter = new AssignmentActivityPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
